    ...
    return (
      <>
          <div className="bottomLinks" style={{textAlign:"left"}}>
              ...
              <div>
                  <p>Top Searched Hotels By Area</p>
                  <div className="links">
                      <a href>Hotels in Panchgani</a>
                      <a href>Hotels in Juhu</a>
                      <a href>Hotels in Srisailam</a>
                      <a href>Hotels in Colaba</a>
                      <a href>Hotels in Bkc</a>
                      <a href>Hotels in Malad West</a>
                      <a href>Hotels in Bandra</a>
                      <a href>Hotels in kochi</a>
                      </div>
              </div>
              <div>
                  <p>More Links</p>
