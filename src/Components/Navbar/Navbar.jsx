  ...
  return (
    <div>
      <div className="class">
        ...
        <ul class="happy-nav" style={{ fontSize: "11px",justifyContent:"space-around" }}>
          <li class="  ">
            <span className="header-sprite nav-icon-flights gr-append-right5"></span>
            <Link to="/flights">
              <h6>Flights</h6>
            </Link>
          </li>
          <li class="  ">
            <span className="header-sprite nav-icon-hotels gr-append-right5"></span>
            <Link to="/hotels">
              <h6>Hotels</h6>
            </Link>
          </li>
          <li class="  ">
            <span className="header-sprite nav-icon-trains gr-append-right5"></span>
            <Link to="/trains">
              <h6>Train</h6>
            </Link>
          </li>
          <li class="  ">
            <span className="header-sprite nav-icon-cabs gr-append-right5"></span>
            <Link to="/cabs">
              <h6>Cabs</h6>
              </Link>
          </li>
        ...
        <div className="gr-make-flex hrtl-center gr-push-right">
          <div className="mytrip__tab gr-append-right20" role="presentation">
            <span className="header-sprite mytrip-icon gr-append-right10"></span>
            <span>
              <div>
                <p className="gr-font10 gr-light gr-helvetica gr-color666">
                  Manage Booking
                </p>
            ...
            <div className="tooltip gr-grey-text--dark">
              <p>
          ...
          <div className="login__tab gotrible" role="presentation">
            <span className="header-sprite user-icon gr-append-right5"></span>
            <div className="gr-font10" role="presentation" id="get_sign_in">
              {token ? (
                <div onClick={handleToken}>
                  <p className="gr-cap-text gr-blue-text gr-bold">Signout</p>
                </div>
              ) : (
                <p
                  className="gr-cap-text gr-blue-text gr-bold"
