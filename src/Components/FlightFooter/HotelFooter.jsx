    ...
    return (
      <>
          <div className="bottomLinks" style={{textAlign:"left"}}>
              ...
              <div>
                  <p>Popular Flight Sectors</p>
                  <div className="links">
                      <a href>Kolkata to Delhi Flight</a>
                      <a href>Hyderabad to Delhi Flight</a>
                      <a href>Chennai to Hyderbad Flight</a>
                      <a href>Chennai to Banglore Flight</a>
                      <a href>Banglore to Pune Flight</a>
                      <a href>Banglore to Mumbai Flight</a>
                      <a href>Kolkata to banglore Flight</a>
                      <a href>Mumabi to Delhi Flight</a>
                      </div>
              </div>
              <div>
                  <p>Top  Sectors</p>
                  <div className="links">
                      ...
                      <a href>Chennai to Hyderbad Flight Vistara Flight</a>
                      <a href>Chennai to Banglore Flight Air India</a>
                      <a href>Banglore to Mumbai Flight Indiago Flight</a>
                      <a href>Kolkata to banglore Flight Vistara Flight</a>
                      <a href>Mumabi to Delhi Flight Vistara Flight</a>
                      <a href>Banglore to Pune Flight Air India</a>
                      </div>
              </div>
              <div>
                  <p>More Links</p>
