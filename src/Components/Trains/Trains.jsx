...
import train3 from "./Screenshot 2024-03-05 094909.png";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowRight } from "@fortawesome/free-solid-svg-icons";
import train55 from "./Screenshot 2024-03-05 104159.png";
import train66 from "./Screenshot 2024-03-05 104640.png"
import train77 from "./Screenshot 2024-03-05 105317.png";
    ...
    Live Train Status
              ...
              <div>
                <div className="from-section">
                  <label>FROM</label>
                  <input type="text" name="" className="input-from"  placeholder="Enter Source name" style={{fontSize:"18px"}}/>
                </div>
              </div>
              <div>
                <div className="from-section">
                  <label>TO</label>
                  <input type="text" name="" className="input-from" placeholder="Enter Destination name" style={{fontSize:"18px"}}/>
                </div>
              </div>
      ...
      <div style={{
        ...
        <h2 style={{ marginTop: '0', marginBottom: '10px', color: '#4d4d4d' }}>Live Train Status</h2>
        <p style={{ color: '#4d4d4d' }}>Railways inquiry just a click away!</p>
        <p>
        <FontAwesomeIcon
                icon={faArrowRight}
                style={{ fontSize: "15.5px", color:"blue",marginRight:"2px",marginTop:"10px" }}
              />
        </p>
      </div>
      <div style={{
        ...
        <h2 style={{ marginTop: '0', marginBottom: '10px', color: '#4d4d4d' }}>Coach & Seat Position</h2>
        <p style={{ marginBottom: '10px', color: '#4d4d4d' }}>View coach & seat layout of the train you wish to</p>
        <p>
        <FontAwesomeIcon
                icon={faArrowRight}
                style={{ fontSize: "15.5px", color:"blue",marginRight:"2px" }}
              />
        </p>
      </div>
      <div style={{
        ...
        <h2 style={{ marginTop: '0', marginBottom: '10px', color: '#4d4d4d' }}>PNR Status</h2>
      ...
      <div style={{
        ...
        <h2 style={{ marginTop: '0', marginBottom: '10px', color: '#4d4d4d' }}>Platform Locator</h2>
      ...
      <div  style={{marginBottom:"20px",marginLeft:"20px"}}>
        ...
        >
          <div style={{marginLeft:"20px",paddingBottom:"10px"}}><h2 style={{justifyContent:"left"}}>Train Booking FAQ</h2></div>
