  ...
  return (
    <div className={styles.mainDiv}>
      <div className="Home">
        ...
        <h2 style={{ marginLeft: "40px", marginBottom: "20px" }}>
          Deal of the day
        </h2>
        <div
          style={{
      ...
      <div class="container">
        ...
        <div class="image-box">
          <img src="https://wallpapercave.com/wp/wp4483177.jpg" alt="Image 4" />
          <h3>Maldives</h3>
        </div>
        <div class="image-box">
          <img
      ...
      <div style={{ marginBottom: "20px", marginLeft: "20px" }}>
        ...
        >
          <div style={{ marginLeft: "20px", paddingBottom: "10px" }}>
            <h2 style={{ justifyContent: "left" }}>Hotel Booking FAQs</h2>
          </div>
        </div>
        <div
          style={{
