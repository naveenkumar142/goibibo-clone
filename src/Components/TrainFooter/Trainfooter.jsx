          ...
          <div className="bottomLinks" style={{textAlign:"left"}}>
              ...
              <div>
                ...
                <div>
                  <p>Top Trains</p>
                  <div className="links">
                      <a href>Mewar Express (12964) </a>
                      <a href>Gujarat Express (22953)</a>
                      <a href>Konark Express (11020)</a>
                      <a href>Shane Punjab (12498)</a>
                      <a href>Taj Express (12279)</a>
                      <a href>Karnavati Express (12933)</a>
                      <a href>AF AII Intercity (12195)</a>
                      <a href>KURJ Express (19666) </a>
                      </div>
              </div>
              <div>
                  <p>Top Train Routes</p>
                  <div className="links">
                      <a href>Jaipur to Jodhpur Trains </a>
                      <a href>Delhi to Chandigarh Trains</a>
                      <a href>Hyderabad to Visakhapatnam Trains</a>
                      <a href>Bangalore to Mysore Trains</a>
                      <a href>Mumbai to Ahmedabad Trains</a>
                      <a href>Patna to Bangalore Trains</a>
                      <a href>Goa to Mumbai Trains</a>
                      <a href>Indore to Jaipur Trains</a>
                      <a href>Bangalore to Hyderabad Trains</a>
                      <a href>Lucknow to Delhi Trains</a>
                      <a href>Chennai to Delhi Trains</a>
                      </div>
              </div>
